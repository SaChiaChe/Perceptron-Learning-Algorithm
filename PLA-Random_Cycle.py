...
for iter in range(TotalIter):
	print("Iter ", iter, ": ", end = "")
	rd.shuffle(Cycle)
	PLAResult = PLA(Data_X, Data_Y, Cycle, -1)
	Finalweight = PLAResult[0]
	FinalUpdateCount = PLAResult[1]
	SumofUpdates += FinalUpdateCount

AvgUpdate = float(SumofUpdates)/TotalIter
print("Average updates: ", AvgUpdate)